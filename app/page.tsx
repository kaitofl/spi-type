...
const typeResults: Record<string, TypeResult> = {
  PBEM: {
    name: '幸運の錬金術師', catchphrase: 'どんな出来事も、次の幸運の材料に。',
    ...
    matches: [{ code: 'NBER', reason: '兆し探偵の観察力が、あなたの楽観にちょうどいい慎重さをくれます。' }, { code: 'PBCM', reason: 'ひらめきを勢いに変えられる二人。企画や旅を一緒に始めると最強。' }],
  ...
  PBER: {
    name: '星追い旅人', catchphrase: '寄り道の先で、いい縁に出会う。',
    ...
    matches: [{ code: 'NBCM', reason: '厄払い隊長の決断力が、迷いがちなあなたの背中を気持ちよく押します。' }, { code: 'PBCR', reason: '偶然を楽しめる者同士。ノープランの旅で忘れられない縁を引き寄せます。' }],
  ...
  PBCM: {
    name: '開運プロデューサー', catchphrase: 'ひとつの幸運から、次の幸運を起こす。',
    ...
    matches: [{ code: 'NDER', reason: '守護騎士が足元を守ってくれるため、安心して大胆な一手を打てます。' }, { code: 'PBEM', reason: 'アイデアと改善力が循環する関係。一緒なら失敗すら次の企画になります。' }],
  ...
  PBCR: {
    name: '引き寄せ招き猫', catchphrase: '来た波に乗れば、未来はもっと面白くなる。',
    ...
    matches: [{ code: 'NDEM', reason: '運命の裁判官の堅実さが、あなたの勢いを安全な幸運へ整えます。' }, { code: 'PBER', reason: '二人とも偶然の達人。寄り道や紹介から面白い未来が生まれます。' }],
  ...
  PDEM: {
    name: '運命の調律師', catchphrase: '決められた物語も、いい音に整えられる。',
    ...
    matches: [{ code: 'NBCR', reason: '嵐待ち黒猫の鋭い察知力を、あなたが落ち着いた行動に翻訳できます。' }, { code: 'PDER', reason: '運命への信頼が共通言語。穏やかで長く続く関係を育てられます。' }],
  ...
  PDER: {
    name: '月夜の案内人', catchphrase: '必要な幸運は、必要なときに届く。',
    ...
    matches: [{ code: 'NDCM', reason: '宿命ブレイカーの突破力をあなたの安心感が包み、強さを持続させます。' }, { code: 'PDEM', reason: '同じリズムで静かに歩ける二人。説明しすぎなくても心が通じます。' }],
  ...
  PDCM: {
    name: '願いの船長', catchphrase: '運命の追い風を、自分でさらに強くする。',
    ...
    matches: [{ code: 'NBER', reason: '兆し探偵が小さな危険を知らせ、あなたは安心して舵を切れます。' }, { code: 'PDCR', reason: '未来への確信が響き合う二人。大きな夢ほど現実味が増します。' }],
  ...
  PDCR: {
    name: '生まれつきスター', catchphrase: 'すべては、最高の未来につながっている。',
    ...
    matches: [{ code: 'NBEM', reason: 'お守り職人の先回り力が、あなたの大きな運を長く安全に支えます。' }, { code: 'PDCM', reason: '確信と行動が揃う華やかなペア。互いの夢を大きくできます。' }],
  ...
  NBEM: {
    name: 'お守り職人', catchphrase: '悪い未来を読んで、先回りで変えていく。',
    ...
    matches: [{ code: 'PDCR', reason: '生まれつきスターの明るい確信が、あなたの不安を未来への期待に変えます。' }, { code: 'NBCM', reason: '察知と即対応が噛み合う守備力の高い二人。困難な場面ほど頼れる関係。' }],
  ...
  NBER: {
    name: '兆し探偵', catchphrase: '焦らず見極めれば、流れはまた整う。',
    ...
    matches: [{ code: 'PBEM', reason: '幸運の錬金術師が、集めた事実から明るく現実的な出口をつくります。' }, { code: 'PDCM', reason: 'あなたが海図を読み、願いの船長が舵を切る。判断と実行の名コンビ。' }],
  ...
  NBCM: {
    name: '厄払い隊長', catchphrase: '嫌な連鎖は、自分のところで断ち切る。',
    ...
    matches: [{ code: 'PBER', reason: '星追い旅人の柔らかさが、戦闘モードのあなたに別の出口を見せます。' }, { code: 'NBEM', reason: '予防と突破の守護ペア。互いの大切なものを本気で守れます。' }],
  ...
  NBCR: {
    name: '嵐待ち黒猫', catchphrase: '流れを読めば、嵐の中にも道はある。',
  ...
  NDEM: {
    name: '運命の裁判官', catchphrase: '決まった試練にも、整え方はきっとある。',
    ...
    matches: [{ code: 'PBCR', reason: '引き寄せ招き猫の明るさが、あなたに予想外の温かい判決を教えます。' }, { code: 'NDER', reason: '責任感と守る力を理解し合える、静かで揺るがない信頼関係。' }],
  ...
  NDER: {
    name: '守護騎士', catchphrase: '今は耐えるとき。流れが戻るまで静かに守る。',
    ...
    matches: [{ code: 'PBCM', reason: '開運プロデューサーが新しい風を運び、あなたはその挑戦に安心の土台をつくります。' }, { code: 'NDEM', reason: '言葉より行動で信頼を示す者同士。長い時間を一緒に越えられます。' }],
  ...
  NDCM: {
    name: '宿命ブレイカー', catchphrase: '決められた悪い流れなら、自分で打ち破る。',
    ...
    matches: [{ code: 'PDER', reason: '月夜の案内人の穏やかさが、戦いの外にある居場所を思い出させます。' }, { code: 'NDCR', reason: '深い問題意識を共有できる二人。静かな確信が大きな変化につながります。' }],
  ...
  NDCR: {
    name: '深夜の占い師', catchphrase: '見えない流れを読み、来るべき時を待つ。',
    ...
    matches: [{ code: 'PDCM', reason: '願いの船長が、あなたの深い予感を現実の航路へ変えてくれます。' }, { code: 'NBCR', reason: '説明しなくても気配を察する二人。安心できる静けさを共有できます。' }],
                ...
                return (
                  <div className="match-row" key={match.code}>
                    <div className="match-image">
                      <img src={`/types/${match.code}.png`} alt={matchedType.name} loading="lazy" />
                      <span>0{index + 1}</span>
                    </div>
                    <div>
