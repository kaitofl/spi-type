...
const questions: Question[] = [
  {
    dimension: 'outlook',
    scene: '友達との旅行当日、乗る予定だった電車が突然運休になった。',
    prompt: 'その瞬間、最初に思うのは？',
    a: '予定になかった場所へ行けるかも',
    b: 'このあともトラブルが続きそう',
  },
  ...
  {
    dimension: 'outlook',
    scene: '知らない番号から着信。留守電には何も残っていない。',
    prompt: '折り返す前に浮かぶのは？',
    a: '何かいい知らせかもしれない',
    b: '面倒な連絡かもしれない',
  },
  {
    dimension: 'fate',
    scene: 'たまたま入ったカフェで、のちに恋人になる人と出会った。',
    prompt: 'この出会いをどう捉える？',
    a: 'あの日の選択が、未来を変えた',
    b: 'いつか出会うことが決まっていた',
  },
  {
    dimension: 'fate',
    scene: '一本乗り遅れた電車が、途中で事故に遭ったとあとから知った。',
    prompt: 'あなたならどう感じる？',
    a: '乗り遅れたことで、未来が変わった',
    b: 'あの電車には乗らない運命だった',
  },
  {
    dimension: 'fate',
    scene: '二社から内定をもらい、直感で選んだ会社で人生を変える仕事に出会った。',
    prompt: '数年後、振り返って思うのは？',
    a: 'あの選択が、新しい道をつくった',
    b: '最初から、この仕事へ来る流れだった',
  },
  {
